...
LOGLEVEL_ROOT = os.environ.get("LOGLEVEL_ROOT", "DEBUG")
LOGLEVEL_DJANGO = os.environ.get("LOGLEVEL_DJANGO", "INFO")
LOGLEVEL_SOCKETIO = os.environ.get("LOGLEVEL_SOCKETIO", "INFO")
LOGLEVEL_PONG = os.environ.get("LOGLEVEL_PONG", "DEBUG")
LOGLEVEL_LIVEGAME = os.environ.get("LOGLEVEL_LIVEGAME", "DEBUG")
